...
string :: String -> Doc
string = annTrace 0 "string" . pretty

parens :: Doc -> Doc
parens = annTrace 1 "parens" . enclose lparen rparen

brackets :: Doc -> Doc
brackets = annTrace 1 "brackets" . enclose lbracket rbracket
...
enclose
    ...
    -> Doc -- ^ x
    -> Doc -- ^ LxR
enclose l r x = annTrace 1 "enclose" (l <> x <> r)
